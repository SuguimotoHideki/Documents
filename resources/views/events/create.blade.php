                    ...
                    <div class="card-body">
                        ...
                        <div class="mx-5">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input id="passing_grade" type="number" min="0" max="10" class="form-control @error('passing_grade') is-invalid @enderror" name="passing_grade" value="{{ old('passing_grade') }}" required autofocus>
                                    @error('passing_grade')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>

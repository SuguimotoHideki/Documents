                ...
                <form method="POST" action="{{ route('storeReview', $document)}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9 my-auto">
                                <input id="score" type="number" step="0.1" min="0" max="10" class="form-control @error('score') is-invalid @enderror" name="score" value="{{ old('score') }}" placeholder="Pontuação da submissão" required autocomplete="score" autofocus>
                                <small class="form-text text-muted">Valor entre 0 e 10, podendo ser decimal.</small>
                                @error('score')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
